...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   <h3>SELL YOUR SNEAKERS</h3>
   <h2>Enter Product name and size</h2>
   <input type="text" name="p_name" placeholder="e.g. Nike Air Jordan 1 'Mocha' Size 10" class="box" required>
   <h2>Enter Price</h2>
   <input type="number" name="p_price" min="0" placeholder="$" class="box" required>
   <h2>Upload Image</h2>
   <input type="file" name="p_image" accept="image/png, image/jpg, image/jpeg" class="box" required>
   <input type="submit" value="List the product" name="add_product" class="btn">
</form>
